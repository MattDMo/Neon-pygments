...
"""
    ...
    :copyright: Copyright 2013-2014 by Matt Morrison mattdmo@mattdmo.com
...
class NeonStyle(Style):
    ...
    styles = {
        ...
        Operator.Word:             "bold #a7a3ff",          # class: 'ow'
        ...
        Name.Class:                "#cfff01",               # class: 'nc'
        Name.Constant:             "italic #eb939a",        # class: 'no'
        Name.Decorator:            "#b6b8fe bg:#070e48",    # class: 'nd'
        Name.Entity:               "#ce5c00",               # class: 'ni'
        Name.Exception:            "bold #ff1e00",          # class: 'ne'
        Name.Function:             "#10ff02",               # class: 'nf'
        Name.Property:             "#b6b8fe",               # class: 'py'
        Name.Label:                "#f57900",               # class: 'nl'
        Name.Namespace:            "#11bd7c",               # class: 'nn'
        Name.Other:                "#ff25d9",               # class: 'nx'
        Name.Tag:                  "bold #02aeff",          # class: 'nt'
        Name.Variable:             "#ff25d9",               # class: 'nv'
        Name.Variable.Class:       "#cfff01",               # class: 'vc'
        Name.Variable.Global:      "#d285cc",               # class: 'vg'
        Name.Variable.Instance:    "#d285cc",               # class: 'vi'
        ...
        String.Doc:                "italic #218b97",        # class: 'sd'
